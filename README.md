...
* A text channel (group chat) will automatically be created for the event where you'll be pinged - you have complete control over this channel, including the ability to rename or delete it (cancelling an event will also automatically delete its channel). A link to this channel will also be added to your event's description.
